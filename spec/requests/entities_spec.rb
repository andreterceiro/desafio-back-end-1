...
RSpec.describe "/entities", type: :request do
  ...
  # EntitiesController, or in your router and rack
  ...
  describe "POST /create" do
    ...
    context "with invalid parameters" do
      it "does not create a new Entity" do
        expect {
          post entities_url,
               params: { entity: invalid_attributes }, as: :json
        }.to change(Entity, :count).by(0)
      end

      it "renders a JSON response with errors for the new entity" do
        post entities_url,
             params: { entity: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested entity" do
        ...
        patch entity_url(entity),
              params: { entity: new_attributes }, headers: valid_headers, as: :json
        entity.reload
